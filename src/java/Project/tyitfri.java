...
public class tyitfri extends JFrame
{
    JLabel j1,j2,j3,j4,j5,j6,j7,j8,j9,j10,j11,j12,j13,j14;
    
    tyitfri() throws FontFormatException, IOException
    {
     super("TYIT Friday");
     ...
     try 
     {
      ...
      PreparedStatement ps = con.prepareStatement("select * from tyitfri");
