...
public class fyitwed extends JFrame
{
    JLabel j1,j2,j3,j4,j5,j6,j7,j8,j9,j10,j11,j12,j13,j14;
    Font f;
    fyitwed() throws IOException, FontFormatException
    {
     super("FYIT Wednesday");
     ...
     try 
     {
      ...
      PreparedStatement ps = con.prepareStatement("select * from fyitwed");
